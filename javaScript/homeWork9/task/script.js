...

{
    ...
    const arrays = ['Main', 'Products', 'About us', 'Contacts'];
...

{
    ...
    */
    ...
    coursesArray.forEach(course => {
        ...
        duration.innerText = `Month duration: ${course.monthDuration}. Hour duration: ${course.hourDuration}`;
